...
export default function PurchaseForm() {
  ...
  const handleSubmit = (event) => {
    ...
    // Placeholder submit flow until backend integration is connected.
      ...
      <div className="space-y-6">
        <div>
          ...
          <input
            ...
            aria-describedby={
              errors.firstName ? "purchase-firstName-error" : undefined
            }
          />
          {errors.firstName && (
            <p
              id="purchase-firstName-error"
        ...
        <div>
          ...
          <input
            ...
            aria-describedby={
              errors.lastName ? "purchase-lastName-error" : undefined
            }
          />
          {errors.lastName && (
            <p
              id="purchase-lastName-error"
              className="text-primary mt-1 text-sm"
            >
              {errors.lastName}
            </p>
        ...
        <div>
          ...
          />
          {errors.email && (
            <p id="purchase-email-error" className="text-primary mt-1 text-sm">
              {errors.email}
            </p>
          )}
        </div>
        ...
        <div>
          ...
          />
          {errors.phone && (
            <p id="purchase-phone-error" className="text-primary mt-1 text-sm">
              {errors.phone}
            </p>
          )}
        </div>
